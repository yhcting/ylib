 ...
 */
static inline int
yset_add(yset_t s, const void *elem, uint32_t elemsz) {
 ...
 */
static inline int
yset_del(yset_t s, const void *elem, uint32_t elemsz) {
 ...
 */
static inline int
yset_contains(const yset_t s, const void *elem, uint32_t elemsz) {
