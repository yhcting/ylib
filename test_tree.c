...
_test_operation(struct ytree* t) {
     ...
     */
    { /* Just scope */
        static const char __vseq[] = { 'F', 'B', 'G', 'A', 'D', 'I', 'C', 'E', 'H' };
     ...
     */
    { /* Just scope */
        static const char __vseq[] = { 'F', 'B', 'G', 'I', 'A', 'D', 'H', 'C', 'E' };
        _test_walker(t, YTREE_WALKER_LEVEL_OT, __vseq);
    }
...
void test_tree() {
    /* pre-order traversal*/
    static const char __preot[] = {'F', 'B', 'A', 'D', 'C', 'E', 'G', 'I', 'H'};
    /* level-order traversal */
    static const char __levelot[] = {'F', 'B', 'G', 'A', 'D', 'I', 'C', 'E', 'H'};
    /* post-order traversal */
    static const char __postot[] = {'A', 'C', 'E', 'D', 'B', 'H', 'I', 'G', 'F'};
    /* reverse pre-order traversal - traverse right to left */
    static const char __r2lpreot[] = {'F', 'G', 'I', 'H', 'B', 'D', 'E', 'C', 'A'};
    /* reverse post-order traversal - traverse right to left */
    static const char __r2lpostot[] = {'H', 'I', 'G', 'E', 'C', 'D', 'A', 'B', 'F'};
